...
**【新增】** 新增前后端专栏支持，删除和增加操作将在后台管理页面中进行

**【优化】** 优化博客页面的专栏

**【优化】** 添加 webfont 思源字体，观感更好
...
**【新增】** 前端新增友链页面，仅支持查询，删除和增加操作将在后台管理页面中进行

**【优化】** 代码背景设置为亮色

## 🛠2021.02.15

**【新增】** 新增访问量统计，已经测试完成，前端未实际使用

**【新增】** 新增文章页面的目录设计，目前开启该目录仍存在部分问题

**【新增】** 新增文章页面的封面，标题，日期样式的测试，等正式版发布后实装

**【新增】** 实现将原本动态导入到现有数据库的功能并添加至初始化脚本

**【优化】** 优化动态页面的 UI 与动效效果

**【优化】** 将部分页面的固定内容修改为可在 frontmatter 以及 themeConfig 中自定义的配置项
